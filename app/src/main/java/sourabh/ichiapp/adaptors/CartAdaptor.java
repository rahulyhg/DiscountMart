...
//    private List<ProductData> productsDataList;
    private List<ProductVarientData> productVarientDataList =  new ArrayList<>();



    ImageLoader imageLoader = AppController.getInstance().getImageLoader();
    ProductVarientData m;
    int position;
    private Context context;

    public CartAdaptor(Activity activity,
                       Context context,
                       List<ProductVarientData> productVarientDataList
                       ) {
        this.activity = activity;
        this.productVarientDataList = productVarientDataList;
    ...
    @Override
    public int getCount() {
        return productVarientDataList.size();
    }

    @Override
    public Object getItem(int location) {
        return productVarientDataList.get(location);
    }
...
//        TextView txtDescription = (TextView) convertView.findViewById(R.id.item_short_desc);
        ...
        m = productVarientDataList.get(position);
        ...
        String member_price = Money.rupees(
                BigDecimal.valueOf(Double.valueOf(m.getMember_price()
                ))).toString();
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                activity.startActivity(new Intent(activity, ProductActivity.class)
                            ...
                            .putExtra(Const.KEY_PRODUCT_DATA,productVarientDataList.get(position)));
            }
        });
...
// Commented to hide plus minus buttons functionality
        ...
        txtAddItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ProductVarientData tempObj = (productVarientDataList).get(position);

...
public class RetailersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        offerCategoryData= (OfferCategoryData) getIntent().getExtras().getSerializable(Const.KEY_OFFER_DATA);


        category_id = offerCategoryData.getId().toString();
        offer_image = offerCategoryData.getImage();

        city_id = "1";

        serviceProvidersAdaptor = new ServiceProvidersAdaptor(this, serviceProviderDataList,offerCategoryData);
